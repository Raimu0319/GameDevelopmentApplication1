...
{
	return ChekkeyCodeRange(key_code) && ((now_key[key_code] == TRUE) &&
...
{
	return ChekkeyCodeRange(key_code) && ((now_key[key_code] == FALSE) &&
		(old_key[key_code] == TRUE));
}

bool InputControl::ChekkeyCodeRange(int key_code)
{
